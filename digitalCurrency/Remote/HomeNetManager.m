...
//系统广告
+(void)advertiseBanner:(NSString*)language CompleteHandle:(void(^)(id resPonseObj,int code))completeHandle{
    NSString *path = @"advertise/all";
    NSMutableDictionary *dic = [NSMutableDictionary new];
    dic[@"location"] = [NSNumber numberWithInteger:0];
