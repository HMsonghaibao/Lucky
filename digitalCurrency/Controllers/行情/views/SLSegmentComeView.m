...
#define kCanSliderLineWidth  (kWindowW-80)/self.segementTitleArray.count


@interface SLSegmentComeView()
...
@implementation SLSegmentComeView
...
- (UIView *)segementContainer
{
    if (!_segementContainer) {
        ...
        _segementContainer.backgroundColor = RGBOF(0x1A212A);
    }
