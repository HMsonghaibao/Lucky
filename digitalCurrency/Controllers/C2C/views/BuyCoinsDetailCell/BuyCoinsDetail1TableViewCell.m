...
-(void)configLabelWithArray:(NSArray*)payArr{
    if (payArr.count == 1) {
        if ([payArr[0] isEqualToString:@"支付宝"]) {
            ...
            self.payWays2Width.constant = 0;
            self.payWay2Left.constant = 0;
            self.payWays3.hidden = NO;
            self.payWays3Width.constant = 16;
