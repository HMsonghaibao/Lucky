...
@implementation SelectCoinTypeView1
-(void)awakeFromNib{
    [super awakeFromNib];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_enterIndex == 1){
        ...
        NSString*str = [self removeFloatAllZero:self.modelArr[indexPath.row].balance];
        cell.coinTypeLabel.text = [NSString stringWithFormat:@"%@ %@",self.modelArr[indexPath.row].coinId,[NSString stringWithFormat:@"%.2f",[str doubleValue]]];
