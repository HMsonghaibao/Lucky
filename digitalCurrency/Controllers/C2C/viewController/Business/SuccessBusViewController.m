...
- (void)viewDidLoad {
    ...
    self.namelabel.text = LocalizationKey(@"Certificationauditpassed");
    self.titlelabel1.text = LocalizationKey(@"preparematerials");
    self.titlelabel2.text = LocalizationKey(@"Submitreview");
    self.titlelabel3.text = LocalizationKey(@"verified");
    [self.Advertisebutton setTitle:LocalizationKey(@"Placeanad") forState:0];
