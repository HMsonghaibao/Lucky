...
//
//    }
    self.title = LocalizationKey(@"Rechargettt");
    
    self.photoAlbumButton.layer.borderWidth = 1;
    self.photoAlbumButton.layer.borderColor = RGB(0, 35, 211).CGColor;
    self.photoAlbumButton.layer.cornerRadius = 5;
    self.photoAlbumButton.layer.masksToBounds = YES;
