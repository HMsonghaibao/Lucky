...
//    }
    ...
    if([model.type isEqualToString:@"0"]){
        ...
        cell.coinType.text = LocalizationKey(@"Partnerrreward");
    }else if ([model.type isEqualToString:@"14"]){
        cell.coinType.text = LocalizationKey(@"TransactionFees");
    }else if ([model.type isEqualToString:@"15"]){
        cell.coinType.text = LocalizationKey(@"lottery");
    }else if ([model.type isEqualToString:@"16"]){
        cell.coinType.text = LocalizationKey(@"Upgradepartner");
    }else{
