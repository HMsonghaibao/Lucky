...
#import "teamPersonModel.h"
@interface TeamPersonChildController ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL _isDragging;
}
...
@implementation TeamPersonChildController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setUpViews];
    self.view.backgroundColor = [UIColor colorWithRed:19/255.0 green:30/255.0 blue:47/255.0 alpha:1/1.0];
    [self.tableView registerNib:[UINib nibWithNibName:@"TeamPersonTableViewCell" bundle:nil] forCellReuseIdentifier:@"TeamPersonTableViewCell"];
    self.tableView.frame=CGRectMake(0, 0, kWindowW, kWindowH-SafeAreaTopHeight-SafeAreaBottomHeight-228);
...
-(void)getData{
    ...
    [MineNetManager generalRecommandListParam:bodydic CompleteHandle:^(id resPonseObj, int code) {
        ...
        if (code) {
            if ([resPonseObj[@"code"] integerValue]==0) {
                ...
                NSArray *dataArr = [teamPersonModel mj_objectArrayWithKeyValuesArray:resPonseObj[@"data"]];
...
-(void)getData2{
    ...
    [bodydic setValue:@"10" forKey:@"pageSize"];
    [bodydic setValue:[YLUserInfo shareUserInfo].ID forKey:@"memberId"];
    [bodydic setValue:@"2" forKey:@"isDirect"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TeamPersonTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"TeamPersonTableViewCell" forIndexPath:indexPath];
    cell.selectionStyle=UITableViewCellSelectionStyleNone;
//    teamPersonModel *model;
//    if (self.childViewType==ChildViewType_USDT) {
...
//    }else if (self.childViewType==ChildViewType_BTC)
//    {
//        if (self.contentArr1.count > indexPath.row) {
//            model = self.contentArr1[indexPath.row];
//        }
//    }else{
//        if (self.contentArr2.count > indexPath.row) {
//            model = self.contentArr2[indexPath.row];
//        }
//    }
//    if ([model.memberLevel integerValue] > 0) {
//        cell.stateL.text = LocalizationKey(@"Realname");
//        cell.stateL.textColor = [UIColor colorWithRed:171/255.0 green:172/255.0 blue:172/255.0 alpha:1.0];
//    }else{
//        cell.stateL.text = LocalizationKey(@"Unrealname");
//        cell.stateL.textColor = [UIColor colorWithRed:247/255.0 green:197/255.0 blue:86/255.0 alpha:1.0];
//    }
