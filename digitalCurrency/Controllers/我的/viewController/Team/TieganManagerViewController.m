...
@interface TieganManagerViewController () <FSPageContentViewDelegate,FSSegmentTitleViewDelegate>
@property (nonatomic, strong) UISegmentedControl *seg;
@property (nonatomic, strong) FSPageContentView * pageContentView;
@property (nonatomic, assign)NSInteger userType;
@end

@implementation TieganManagerViewController
...
//    self.title = [[ChangeLanguage bundle] localizedStringForKey:@"Teammanagement" value:nil table:@"English"];
    ...
    for (NSString *title in titles) {
        ...
        }else if ([title isEqualToString:@"有效玩家"]) {
