...
//        [collectionView registerClass:[HZBannerCell class] forCellWithReuseIdentifier:reusedID];
        [collectionView registerNib:[UINib nibWithNibName:@"HZBannerTableViewCell" bundle:nil] forCellWithReuseIdentifier:reusedID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HZBannerTableViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reusedID forIndexPath:indexPath];
