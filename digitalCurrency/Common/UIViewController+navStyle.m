...
//    [tradeButton setImage:[UIImage imageNamed:picturename] forState:UIControlStateNormal];
//    [tradeButton addTarget:self action:@selector(RighttouchEvent) forControlEvents:UIControlEventTouchUpInside];
//    [tradeButton setTintColor:[UIColor whiteColor]];
...
//    self.navigationItem.leftBarButtonItem = leftItem;
    ...
    tradeButton.frame= CGRectMake(0, 0, 30, 30);
    [tradeButton setImage:[UIImage imageNamed:picturename] forState:UIControlStateNormal];
    [tradeButton addTarget:self action:@selector(LefttouchEvent) forControlEvents:UIControlEventTouchUpInside];
    [tradeButton setTintColor:[UIColor whiteColor]];
    UIBarButtonItem *tradeBtn= [[UIBarButtonItem alloc] initWithCustomView:tradeButton];
    self.navigationItem.leftBarButtonItem=tradeBtn;
