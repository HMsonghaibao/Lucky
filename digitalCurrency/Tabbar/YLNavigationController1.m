...
@interface YLNavigationController1 ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@implementation YLNavigationController1
...
+(void)initialize{
    if (self == [YLNavigationController1 class]) {
        //.预备步骤，先要获取导航条的外观
//        UINavigationBar *bar = [UINavigationBar appearance];
        ...
        bar.tintColor = AppTextColor_333333;
